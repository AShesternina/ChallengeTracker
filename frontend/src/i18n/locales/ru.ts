const ru = {
  ...
  auth: {
    ...
    check_email_body: "Мы отправили ссылку для подтверждения на {email}. Нажмите на неё, чтобы активировать аккаунт.",
    resend_verification: "Отправить снова",
    resend_done: "Отправлено!",
    verify_success: "Email подтверждён!",
    verify_success_body: "Аккаунт активирован. Теперь доступны все функции.",
    verify_error: "Неверная или устаревшая ссылка",
    verify_error_body: "Ссылка для подтверждения недействительна или уже была использована.",
    go_to_app: "Перейти в приложение",
    not_verified_hint: "Email не подтверждён",
  },
  momentum: {
  ...
  settings: {
    ...
    email_reports: "Email-отчёты",
    email_daily: "📊 Итоги дня",
    email_daily_hint: "Получать сводку выполнения каждый вечер",
    email_weekly: "🏆 Итоги недели",
  ...
  onboarding: {
    ...
    welcome_question: "Над чем хотите работать?",
    welcome_hint: "36 челленджей · 9 категорий · старт за 1 минуту",
    challenges_count: "челленджа",
    see_all_categories: "+ ещё {{count}} категорий",
    name_label: "Ваше имя (необязательно)",
    name_placeholder: "например, Саша",
    name_hint: "Будем использовать в напоминаниях",
    get_started: "Начать",
    pick_category_title: "Все категории",
    pick_category_subtitle: "Выберите категорию, чтобы увидеть челленджи",
    pick_title: "Выберите челлендж",
    pick_subtitle: "Или создайте свой",
  ...
  templates_page: {
    title: "Библиотека челленджей",
    subtitle: "36 челленджей в 9 категориях",
