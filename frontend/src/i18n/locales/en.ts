const en = {
  ...
  auth: {
    ...
    resend_done: "Sent!",
    verify_success: "Email confirmed!",
    verify_success_body: "Your account is activated. You can now use all features.",
    verify_error: "Invalid or expired link",
    verify_error_body: "The confirmation link is invalid or has already been used.",
    go_to_app: "Go to app",
    not_verified_hint: "Email not confirmed",
  },
  momentum: {
  ...
  settings: {
    ...
    email_daily: "📊 Daily results",
    email_daily_hint: "Receive a completion summary every evening",
  ...
  onboarding: {
    ...
    welcome_question: "What do you want to work on?",
    welcome_hint: "36 challenges · 9 categories · start in 1 minute",
    challenges_count: "challenges",
    see_all_categories: "+ {{count}} more categories",
    name_label: "Your name (optional)",
    name_placeholder: "e.g. Alex",
    name_hint: "We'll use it in reminders",
    get_started: "Get Started",
    pick_category_title: "All categories",
    pick_category_subtitle: "Choose a category to see challenges",
    pick_title: "Pick a challenge",
    pick_subtitle: "Or create your own",
  ...
  templates_page: {
    ...
    subtitle: "36 challenges in 9 categories",
